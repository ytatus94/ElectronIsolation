...
void myIsoVar_compare_topoetcone40_data_driven_shift(TString menu = "TightLLH_d0z0_v8")
{
    //SetAtlasStyle();
    ...
    TString path1 = "/afs/cern.ch/work/y/yushen/private/TagAndProbe/MyTagAndProbe_test32/TagAndProbeFrame/util/testLxplus1/";
    ...
    TString path2 = "/afs/cern.ch/work/y/yushen/private/TagAndProbe/MyTagAndProbe_test32/TagAndProbeFrame/util/testLxplus5/";
