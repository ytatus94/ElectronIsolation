// This script is used to compare Eff with and without background subtraction for single pT bin.
// Usage: root -l myCompEff.C"(\"TightLLHMC15_v9\",\"isolTight\")"
//
//
#include <TROOT.h>
#include <TFile.h>
...
void myCompEff(TString menu = "TightLLHMC15_v9",
			   ...
			   int pt = 2)
{
	...
	eta2[0][pt]->SetYTitle("Efficiency");
	...
	c1->SaveAs("plots/CompEff_pT" + TString::Itoa(ptLowEdge,10) + "-" + TString::Itoa(ptUpEdge,10) + "_" + folder + ".pdf", "pdf");
}
