...
// The selected eta bin will be projected on the pT axis.
                               ...
                               int eta = 12)
{
    ...
    TString fileName1 = "../MC15bd0z0_ScaleFactors.root";
...
//--------------------
    ...
    TString fileName2 = "../ScaleFactors.root";
...
//--------------------
    ...
    leg1->AddEntry(pt1[0][eta], "file1", "lp");
    leg1->AddEntry(pt2[0][eta], "file2", "lp");
...
//--------------------
    ...
    leg3->AddEntry(pt1[1][eta], "file1", "lp");
    leg3->AddEntry(pt2[1][eta], "file2", "lp");
...
//--------------------
    ...
    leg5->AddEntry(pt1[1][eta], "file1", "lp");
    leg5->AddEntry(pt2[1][eta], "file2", "lp");
