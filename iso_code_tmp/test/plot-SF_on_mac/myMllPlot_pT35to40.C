// This is used to make Mll plots for pT = 35-40 GeV (Medium pT).
// Usage: root myMllPlot_pT35to40.C"(\"TightLLHMC15_v6\",\"TagTightPlusPlusAndCaloIso\",true)"
//
//
#include <TROOT.h>
#include <TFile.h>
...
void myMllPlot_pT35to40(TString menu = "TightLLHMC15_v9",
