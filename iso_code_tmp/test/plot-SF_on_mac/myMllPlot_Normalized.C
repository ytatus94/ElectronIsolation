...
void myMllPlot_Normalized(TString menu = "TightLLHMC15_v9",
                          ...
                          bool isData  = true)
{
	...
	TString histo;
	if (isData)
		histo =  menu + iso + "_" + bkg_template + "_" + tag + "_Data_Den_Mll_3d";
	else
		histo =  menu + iso + "_" + bkg_template + "_" + tag + "_MCZee_NoFilter_Den_Mll_3d";
	...
	TString histoNum;
	if (isData)
		histoNum =  menu + iso + "_" + bkg_template + "_" + tag + "_Data_Num_Mll_3d";
	else
		histoNum =  menu + iso + "_" + bkg_template + "_" + tag + "_MCZee_NoFilter_Num_Mll_3d";
