...
// Make plots of ptcone20, ptvarcone20, topoetcone20, topoetcone40, ptvarcone20/pt, and topoetcone20/pt.
...
void myIsoVar8(TString menu = "TightLLH_Smooth_v11_isolPhFixedCutLoose")
{
    SetAtlasStyle();
    bool debug = true;
    ...
    TString h_2D_el_ptcone20_vs_pt = "PlotVars_" + menu + "_h_2D_el_ptcone20_vs_pt";
    TString h_2D_el_ptvarcone20_vs_pt = "PlotVars_" + menu + "_h_2D_el_ptvarcone20_vs_pt";
    TString h_2D_el_topoetcone20_vs_pt = "PlotVars_" + menu + "_h_2D_el_topoetcone20_vs_pt";
    TString h_2D_el_topoetcone40_vs_pt = "PlotVars_" + menu + "_h_2D_el_topoetcone40_vs_pt";
    TString h_2D_el_ptvarcone20_over_pt_vs_pt = "PlotVars_" + menu + "_h_2D_el_ptvarcone20_over_pt_vs_pt";
    TString h_2D_el_topoetcone20_over_pt_vs_pt = "PlotVars_" + menu + "_h_2D_el_topoetcone20_over_pt_vs_pt";

    // Get data
    TH2F *data_2D_el_ptcone20_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_ptcone20_vs_pt);
    TH2F *data_2D_el_ptvarcone20_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_ptvarcone20_vs_pt);
    TH2F *data_2D_el_topoetcone20_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_topoetcone20_vs_pt);
    TH2F *data_2D_el_topoetcone40_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_topoetcone40_vs_pt);
    TH2F *data_2D_el_ptvarcone20_over_pt_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_ptvarcone20_over_pt_vs_pt);
    TH2F *data_2D_el_topoetcone20_over_pt_vs_pt = (TH2F *)fdata->Get(folder + "/" + h_2D_el_topoetcone20_over_pt_vs_pt);

    data_2D_el_ptcone20_vs_pt->Sumw2();
    data_2D_el_ptvarcone20_vs_pt->Sumw2();
    data_2D_el_topoetcone20_vs_pt->Sumw2();
    data_2D_el_topoetcone40_vs_pt->Sumw2();
    data_2D_el_ptvarcone20_over_pt_vs_pt->Sumw2();
    data_2D_el_topoetcone20_over_pt_vs_pt->Sumw2();

    if (debug) {
        // Data
        cout << data_2D_el_ptcone20_vs_pt << endl;
        cout << data_2D_el_ptvarcone20_vs_pt << endl;
        cout << data_2D_el_topoetcone20_vs_pt << endl;
        cout << data_2D_el_topoetcone40_vs_pt << endl;
        cout << data_2D_el_ptvarcone20_over_pt_vs_pt << endl;
        cout << data_2D_el_topoetcone20_over_pt_vs_pt << endl;
    }

    // Get MC
    TH2F *mc_2D_el_ptcone20_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_ptcone20_vs_pt);
    TH2F *mc_2D_el_ptvarcone20_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_ptvarcone20_vs_pt);
    TH2F *mc_2D_el_topoetcone20_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_topoetcone20_vs_pt);
    TH2F *mc_2D_el_topoetcone40_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_topoetcone40_vs_pt);
    TH2F *mc_2D_el_ptvarcone20_over_pt_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_ptvarcone20_over_pt_vs_pt);
    TH2F *mc_2D_el_topoetcone20_over_pt_vs_pt = (TH2F *)fmc->Get(folder + "/" + h_2D_el_topoetcone20_over_pt_vs_pt);

    mc_2D_el_ptcone20_vs_pt->Sumw2();
    mc_2D_el_ptvarcone20_vs_pt->Sumw2();
    mc_2D_el_topoetcone20_vs_pt->Sumw2();
    mc_2D_el_topoetcone40_vs_pt->Sumw2();
    mc_2D_el_ptvarcone20_over_pt_vs_pt->Sumw2();
    mc_2D_el_topoetcone20_over_pt_vs_pt->Sumw2();

    if (debug) {
        // MC
        cout << mc_2D_el_ptcone20_vs_pt << endl;
        cout << mc_2D_el_ptvarcone20_vs_pt << endl;
        cout << mc_2D_el_topoetcone20_vs_pt << endl;
        cout << mc_2D_el_topoetcone40_vs_pt << endl;
        cout << mc_2D_el_ptvarcone20_over_pt_vs_pt << endl;
        cout << mc_2D_el_topoetcone20_over_pt_vs_pt << endl;
    }
